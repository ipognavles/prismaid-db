-- ============================================================================
-- PRISMAID AUTHENTICATION & AUTHORIZATION SCHEMA
-- ============================================================================
-- Purpose: Add user authentication, role-based access control, and audit logging
-- Created: 2026-01-10
...
-- Verify schema creation (uncomment to run after migration)
-- SELECT 'Users table created' as status, COUNT(*) as user_count FROM pmd_users;
-- SELECT 'Roles table created' as status, COUNT(*) as role_count FROM pmd_roles;
-- SELECT 'Admin user has admin role' as status, COUNT(*) as count
-- FROM pmd_user_roles ur
-- JOIN pmd_users u ON ur.pmd_user_id = u.pmd_user_id
-- JOIN pmd_roles r ON ur.pmd_role_id = r.pmd_role_id
