-- ============================================================================
-- Prismaid Database - SSO (Single Sign-On)
-- ============================================================================
-- Description: SSO provider configurations for Microsoft Entra (Azure AD),
--              Google, Okta, and other SAML/OAuth providers
-- Dependencies: 002_auth.sql (pmd_users, pmd_roles)
-- Tables: pmd_sso_providers, pmd_sso_role_mappings, pmd_sso_user_identities
-- ============================================================================
...
-- ============================================================================
-- SEED DATA - Default Microsoft Entra (Azure AD) Provider (Disabled)
-- ============================================================================
